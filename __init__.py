...
bl_info = {
    ...
    "author": "Mateusz Dera",'version' : (1, 0),
	'blender' : (2, 82, 0),
	"location": "View3D > Toolshelf > Anime Hair",
	'description' : "",
    'category': 'Tools'
}
...
class generate(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        def single_hair(closed, simple, p0, p1, p3):
            ...
            mat.diffuse_color = (float(0.5), 0.0, 1.0, 0.0)
            ...
            # Transform
            bpy.context.view_layer.objects.active.scale = p3[0]
            bpy.context.view_layer.objects.active.rotation_euler = p3[1]
            bpy.context.view_layer.objects.active.location = p3[2]
